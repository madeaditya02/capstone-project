...
import type { StatLabel, Stress } from "../../utils/types";
      ...
      <div className="flex flex-col gap-4 border-b border-slate-100 pb-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-slate-500">{recordedDays} hari tercatat</p>
          </div>
        </div>

        <div className="flex items-center justify-between gap-4 sm:justify-end">
          <StressBadge label={stressStatus} />

          <div className="text-right">
            <p className="text-xs text-slate-500">Rata-rata Stress</p>
            <p className="text-lg font-bold leading-tight text-slate-800">{averageStress}</p>
          </div>
